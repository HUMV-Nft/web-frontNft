export default function LeftSideBar() {
  return (
    <aside
      className="grid gap-10 overflow-y-auto w-fit px-5 md:px-10 py-10 mx-auto xl:w-[800px] scroll-bar text-start
    text-white h-[1000px] xl:h-[700px] bg-zinc-800/50 rounded-lg">
      <iframe
        style={{
          width: "100%",
          maxWidth: "500px",
