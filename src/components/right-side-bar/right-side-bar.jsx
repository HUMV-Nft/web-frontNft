...
export default function RightSideBar() {
  return (
    <aside className="max-w-[600px] mx-auto xl:mx-0 xl:max-w-[500px] xl:w-full grid gap-5 overflow-y-auto max-h-[700px] overflow-x-hidden scroll-bar scroll-bar-r p-4 bg-zinc-800/50 rounded-lg">
